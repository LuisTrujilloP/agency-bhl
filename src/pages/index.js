...
function HomePage({
	...
	return (
		<>
			<Head>
				<title>Business Name React App</title>
				<meta
					name="description"
					content="React Business Template is an excellent solution to the web designing needs for your website related to creative agency, business, portfolio, corporate, etc. "
				/>
			</Head>
			<HeaderOne />
